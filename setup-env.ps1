...
# Client Origins
Write-Host ">> 允许的前端域名 [默认: https://yinxintest99.edgeone.app,https://yixinaipsy.com,https://www.yixinaipsy.com]:" -ForegroundColor Cyan -NoNewline
$origins = Read-Host " "
$config['CLIENT_ORIGINS'] = if ($origins) { $origins } else { "https://yinxintest99.edgeone.app,https://yixinaipsy.com,https://www.yixinaipsy.com" }
